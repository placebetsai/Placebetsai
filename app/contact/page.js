      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-6 py-4 bg-slate-900 border border-slate-700 rounded-xl text-white placeholder-slate-500 appearance-none focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/30 transition-shadow shadow-inner"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-6 py-4 bg-slate-900 border border-slate-700 rounded-xl text-white placeholder-slate-500 appearance-none focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/30 transition-shadow shadow-inner resize-none"
          />
        </div>
