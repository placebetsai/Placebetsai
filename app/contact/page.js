      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-6 py-4 bg-slate-900/80 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/30 transition-shadow shadow-inner"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-6 py-4 bg-slate-900/80 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/30 transition-shadow shadow-inner resize-none"
          />
        </div>
        ...
        <button
          ...
          className="w-full py-5 bg-cyan-500 text-black font-bold rounded-xl hover:bg-cyan-400 disabled:opacity-70 transition-shadow shadow-lg hover:shadow-cyan-500/50 text-xl uppercase tracking-wide"
        >
