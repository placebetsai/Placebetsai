...
export default function BlogPost() {
  return (
    <Layout>
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"College Debt Not Worth It: When Student Loans Cost More Than Your Degree Returns","description":"Real data on when college debt exceeds lifetime earnings gains. See the numbers on student loans, ROI by major, and what actually makes college worth it.","datePublished":"2025-03-05","dateModified":"2025-03-05","author":{"@type":"Person","name":"Danielle Torres"},"publisher":{"@type":"Organization","name":"IHateCollege.com","url":"https://ihatecollege.com"},"url":"https://ihatecollege.com/blog/college-debt-not-worth-it","mainEntityOfPage":{"@type":"WebPage","@id":"https://ihatecollege.com/blog/college-debt-not-worth-it"}}` }} />
      </Head>
      <SEO
        title="College Debt Not Worth It: When Student Loans Cost More Than Returns"
        description="Real data on when college debt exceeds lifetime earnings gains. See the numbers on student loans, ROI by major, and what actually makes college worth it."
      />
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 text-slate-200">
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-300 leading-relaxed">College debt not being worth it isn&apos;t a fringe position anymore—it&apos;s a mathematical reality for millions of borrowers. When you borrow $30,000-$100,000+ for a degree that might pay $45,000-$60,000 per year, the risk-to-reward ratio is unfavorable. The cost of college has increased 1,460 percent since 1980 while wages have stagnated. Default rates in the millions prove that many borrowers cannot afford their payments. Meanwhile, alternative paths like trade careers and coding bootcamps now deliver equivalent or superior financial outcomes without the debt burden. This doesn&apos;t mean college is never worth it. It means the decision to attend requires honest analysis: What is your specific major? What will it pay? How much will you borrow? What is the actual ROI? Are there cheaper alternatives? Can you afford to graduate? The one-size-fits-all narrative that &apos;college is always worth it&apos; is not just wrong—it&apos;s financially dangerous. You wouldn&apos;t make a $120,000 investment without analyzing the return. Your education is a $120,000+ investment. Analyze accordingly. If the numbers don&apos;t clearly show a positive ROI within 10 years of graduation, debt-financed college probably isn&apos;t worth it for you. That&apos;s not anti-education. It&apos;s pro-math.</p>
        </section>
