...
const TOPICS = [
  ...
  { subject: "Top 10 highest paid WWE wrestlers 2026",         angle: "contract values, downside guarantees, bonuses" },
  { subject: "WWE vs AEW roster depth comparison 2026",        angle: "star power, mid-card, tag teams, women's division" },
  ...
  { subject: "indie wrestling stars who should be in WWE 2026", angle: "names WWE should sign immediately" },
  ...
  { subject: "women's wrestling revolution 2026 state of play", angle: "best workers, title pictures, who's been booked strong" },
  { subject: "wrestling injuries: stars on the shelf in 2026", angle: "who's hurt, expected return dates, career impact" },
  { subject: "AEW vs WWE Monday night ratings war 2026",       angle: "weekly viewership numbers and trend analysis" },
  { subject: "best wrestling promos of all time ranked",       angle: "Austin 3:16, Pipe Bomb, Dusty Rhodes, Ric Flair" },
  { subject: "CM Punk's impact back in WWE 2026",              angle: "feuds, title picture, crowd reactions, business impact" },
  { subject: "Cody Rhodes title reign analysis",               angle: "defenses, booking quality, long-term storytelling" },
  { subject: "tag team wrestling is thriving in 2026",         angle: "best teams in WWE and AEW, what makes a great team" },
  ...
  { subject: "Japanese wrestling influence on WWE and AEW 2026", angle: "NJPW crossovers, strong style, Shinsuke Nakamura legacy" },
  { subject: "wrestling video games ranked best to worst 2026", angle: "WWE 2K25 review, classic games, what fans want" },
  { subject: "MMA vs pro wrestling: crossover fighters in 2026", angle: "Brock Lesnar blueprint, who's crossed over successfully" },
  { subject: "wrestling merchandise revenue breakdown 2026",   angle: "who sells the most shirts, action figures, collectibles" },
